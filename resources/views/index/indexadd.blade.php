    ...
    <div id="page-infinite-scroll-bottom" class="page">
        ...
        <div class="all-list-wrapper">
            ...
            <div class="menu-list-wrapper" id="divSortList">
                ...
                <li sortid='0' class='cateid' cate_id="9999" ><span class='items'>全部商品</span></li>
                @foreach($data as $k=>$v)
                <li sortid='100' reletype='1' linkaddr='' class="cateid" cate_id="{{$v->cate_id}}"><span class='items'>{{$v->cate_name}}</span></li>
                @endforeach
                </ul>
            </div>
                        ...
                        <div class="goodList mui-scroll">
                            <ul id="ulGoodsList" class="mui-table-view mui-table-view-chevron">
                                ...
                                <li id="23468">    
                                    ...
                                    <div class="gList_r">        
                                        <a href="/goodsadd?id={{$v->goods_id}}" id="click"><h3 class="gray6" goods_id="{{$v->goods_id}}" style="color:red">{{$v->goods_name}}</h3></a>        
                                        ...
                                        <div class="gRate">            
                                            ...
                                            <a codeid="12785750" class="gouwu" canbuy="646" href="/goodsgouwu?id={{$v->goods_id}}" goods_id="{{$v->goods_id}}" ></a>        
                                        </div>    
                                    </div>
                                </li>
                               @endforeach
...
<div class="footer clearfix">
    <ul>
        ...
        <li class="f_announced"><a href="{{url('indexadd')}}"  class="hover"><i></i>所有商品</a></li>
